...
\begin{enumerate}[label=(\Alph*)]
  \item \labeltext[Subtask~(A)]{reading multiple electricity and generation meters~\footnote{This survey is particularly interested in meters which utilize the \acf{SML} communication protocol to expose their internal measurement data via the optical D0 interface. \url{https://www.msxfaq.de/sonst/bastelbude/smartmeter_d0_sml.htm}}}{itm:survey-task-read-meters}
