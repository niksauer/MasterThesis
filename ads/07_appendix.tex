...
From here on, \citeauthor{fielding2000architectural} explain that \ac{REST} components perform actions on a resource by exchanging stateless messages composed of \cite[pp.~90--91]{fielding2000architectural}:
...
It shall be noted that a message originating from a client component may include different fields than that delivered by a server component in response \cite[pp.~93--94]{fielding2000architectural}. This discrepancy is displayed in \autoref{tab:rest-message-fields}.
